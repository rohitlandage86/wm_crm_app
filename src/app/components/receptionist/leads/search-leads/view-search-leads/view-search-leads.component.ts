...
@Component({
  selector: 'app-view-search-leads',
  templateUrl: './view-search-leads.component.html',
  styleUrl: './view-search-leads.component.scss'
})
export class ViewSearchLeadsComponent implements OnInit {
  form!: FormGroup;
  isEdit = false;
  lead_hid: any
